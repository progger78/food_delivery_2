...
import '/screens/PopularDetailScreen/popular_detail_screen.dart';
          ...
          itemBuilder: (BuildContext context, int index) {
            return GestureDetector(
              onTap: () => Navigator.of(context)
                  .pushNamed(PopularDetailScreen.routeName),
              child: Container(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              AppBigText(
                                text: 'Tasty And Crispy French-Fries',
                                color: Colors.black,
                              ),
                              AppSmallText(
                                  text: 'With elegance of classic recipies'),
                              Row(
                                mainAxisAlignment:
